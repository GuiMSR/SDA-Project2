...
/* ------------------------------------------------------------------------- *
 * Create a fully closed square maze.
 *
 * PARAMETERS
...
/* ------------------------------------------------------------------------- *
 * Generate a random valid maze in place (i.e. the current maze structure is
 * erased/replaced).
 *
 * PARAMETERS
 * maze         The maze
 ...
 *
 * RETURN
 * opened       True if the wall is closed, false otherwise
 * ------------------------------------------------------------------------- */
 ...
 * close        true if the wall should be closed, false if it should be opened.
 * ------------------------------------------------------------------------- */
